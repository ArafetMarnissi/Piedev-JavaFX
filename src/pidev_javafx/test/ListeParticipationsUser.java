 ...
 * @author mmarr
 */
public class ListeParticipationsUser extends Application {
    
    @Override
    public void start(Stage primaryStage) {
        try {
            //Parent root = FXMLLoader.load(getClass().getResource("/pidev_javafx.GUI/AfficherCoach.fxml"));
            Parent root=FXMLLoader.load(getClass().getResource("/pidev_javafx/GUI/ListeParticipationsUser.fxml"));
