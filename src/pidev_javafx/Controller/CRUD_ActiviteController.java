...
public class CRUD_ActiviteController implements Initializable {
    ...
    @FXML
    private TableColumn<Activite, String> coach_activite_column;
    @FXML
    ...
    Activite c1;
    @FXML
    private Button btn_participations;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        private void affich(){
                                    coach_activite_column.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Activite, String>, ObservableValue<String>>() {
        @Override
        public ObservableValue<String> call(TableColumn.CellDataFeatures<Activite, String> cellData) {
            Coach coach = cellData.getValue().getCoach(); // récupérer l'utilisateur associé à la commande
            return new SimpleStringProperty(coach.getNom_coach()); // retourner le nom de l'utilisateur
        }
    });
 ...
 Date d=java.sql.Date.valueOf(date_activite_modif.getValue());
    ...
    @FXML
    private void consulter_participataionsOnClick(ActionEvent event) throws IOException {
                                         FXMLLoader loader = new FXMLLoader(getClass().getResource("/pidev_javafx/gui/DashbordBack.fxml"));
                                        Parent root = loader.load();
                                       DashbordBackController controller = loader.getController();
                     
                                                        try {
                                                            FXMLLoader loader2 = new FXMLLoader(getClass().getResource("/pidev_javafx/gui/AffichageParticipation.fxml"));
                                                        ...
                                                        anchorpane_affich_acts_back.getScene().setRoot(root);
